...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("MicroserviceEvaluationReport");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("MicroserviceEvaluationReport");
        ...
        config.getMapConfigs().put("qnu.cntt.dacky.domain.*", initializeDomainMapConfig(jHipsterProperties));
