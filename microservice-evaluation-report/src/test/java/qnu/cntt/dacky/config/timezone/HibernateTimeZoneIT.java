package qnu.cntt.dacky.config.timezone;

import qnu.cntt.dacky.MicroserviceEvaluationReportApp;
import qnu.cntt.dacky.config.SecurityBeanOverrideConfiguration;
import qnu.cntt.dacky.repository.timezone.DateTimeWrapper;
import qnu.cntt.dacky.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, MicroserviceEvaluationReportApp.class})
