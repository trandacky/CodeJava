...
import qnu.cntt.dacky.UaaApp;

import qnu.cntt.dacky.config.Constants;
import qnu.cntt.dacky.config.audit.AuditEventConverter;
import qnu.cntt.dacky.domain.PersistentAuditEvent;
...
import static qnu.cntt.dacky.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
