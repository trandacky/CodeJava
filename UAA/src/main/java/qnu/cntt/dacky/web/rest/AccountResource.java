...
import qnu.cntt.dacky.service.dto.PasswordChangeDTO;
import qnu.cntt.dacky.service.dto.AccountDTO;
import qnu.cntt.dacky.web.rest.errors.*;
...
public class AccountResource {
	...
	public void activateAccount(@RequestParam(value = "key") String key) {
		Optional<Account> user = userService.activateRegistration(key);
		if (!user.isPresent()) {
	...
	public AccountDTO getAccount() {
		return userService.getUserWithAuthorities().map(AccountDTO::new)
	...
	public void requestPasswordReset(@RequestBody String mail) {
		Optional<Account> user = userService.requestPasswordReset(mail);
		if (user.isPresent()) {
			mailService.sendPasswordResetMail(user.get());
		} else { // Pretend the request has been successful to prevent checking which emails
	...
	public void finishPasswordReset(@RequestBody KeyAndPasswordVM keyAndPassword) {
		...
		Optional<Account> user = userService.completePasswordReset(keyAndPassword.getNewPassword(),
