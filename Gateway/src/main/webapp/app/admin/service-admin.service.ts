...
export class AdminService {
  ...
  getDepartmentByCourseId(page: Number, uuid: String): Observable<any> {
    return this.http.get(this.urlUAA + '/admin/get-department-by-course?page=' + page + '&uuid=' + uuid);
  }
  getCourseByDepartmentId(page: Number, uuid: String): Observable<any> {
    return this.http.get(this.urlUAA + '/admin/get-course-by-department?page=' + page + '&uuid=' + uuid);
  }
